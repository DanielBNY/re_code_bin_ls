...
int64_t function_16343(int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5) {
    ...
    int64_t v15; // 0x163d7
    if ((int32_t)a3 < 37) {
        int32_t * v16 = (int32_t *)__errno_location(); // 0x1638c
        *v16 = 0;
        unsigned char v17 = *(char *)&v1; // 0x16395
        int64_t v18 = *(int64_t *)__ctype_b_loc(); // 0x163a3
        ...
        if (v20 == 45) {
            ...
            if (v15 == a1) {
                ...
                if (v25 == 0 || a5 == 0) {
                    ...
                    v1 = a5;
                    int64_t v27 = strchr(a5, v26, v14); // 0x16461
                    v8 = 0;
                    v11 = v26;
                    v7 = a1;
                    v10 = 1;
  ...
  lab_0x163ee:
    ...
    if (a5 == 0) {
        ...
        if (v71 != 0) {
            ...
            v1 = a5;
            int64_t v73 = strchr(a5, v72, v14); // 0x1651c
