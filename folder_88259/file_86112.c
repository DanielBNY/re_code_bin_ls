...
int64_t function_168d3(int64_t a1, int64_t a2, int64_t a3) {
    ...
    int64_t v4 = function_4900(v3); // 0x16906
...
int64_t function_15060(uint32_t a1, int64_t a2, int64_t a3, int64_t a4) {
    ...
    int64_t v5 = function_4930(1, v3, v2, &v4, 256); // 0x150a9
    int64_t v6 = v3; // 0x150b0
    if ((int32_t)v5 != 0) {
        uint32_t v7 = *(int32_t *)function_4760(); // 0x15174
        function_4c60(1, v7, "%s", v2);
        v6 = v7;
    }
    ...
    int64_t v11 = function_4930(1, v8, v9, &v10, 256); // 0x150e2
    int64_t v12 = v8; // 0x150e9
    if ((int32_t)v11 != 0) {
        uint32_t v13 = *(int32_t *)function_4760(); // 0x15154
        function_4c60(1, v13, "%s", v9);
        v12 = v13;
    }
