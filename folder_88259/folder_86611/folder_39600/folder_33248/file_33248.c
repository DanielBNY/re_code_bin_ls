...
int64_t function_81e0(int64_t * a1, int64_t a2, int64_t a3, int64_t a4, int32_t a5, int64_t * a6) {
      ...
      lab_0x84b5:
        ...
        switch (v67) {
            ...
            default: {
                ...
                int64_t v69 = wcwidth((int64_t)v63); // 0x84fa
                ...
                if ((int32_t)v69 < 0) {
                    ...
                    *(char *)v59 = 63;
                    ...
                    int64_t v76 = mbsinit(&v55); // 0x84ac
                    v73 = v75;
                    v71 = v66;
                    v72 = v74;
                    v33 = v66;
                    ...
                    *(char *)(v70 + v59) = v77;
                    ...
                    int64_t v82 = mbsinit(&v55); // 0x8528
                    v73 = v81;
                    v71 = v80;
                    v72 = v79;
                    if ((int32_t)v82 != 0) {
  ...
  lab_0x82b0:;
    ...
    if (a5 == 0) {
        ...
        if (__ctype_get_mb_cur_max() < 2) {
            ...
            v112 = v12;
            if (v5 != 0 && v114 >= v17) {
                int64_t v115 = *(int64_t *)__ctype_b_loc(); // 0x82de
  ...
  lab_0x8389:;
    ...
    if (__ctype_get_mb_cur_max() < 2) {
        ...
        v126 = v121;
        if (v43 > v125) {
            int64_t * v132 = (int64_t *)__ctype_b_loc(); // 0x83c3
