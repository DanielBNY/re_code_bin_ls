...
int64_t function_11023(int64_t a1, int64_t a2, int64_t a3, uint64_t a4, int64_t a5, uint64_t a6) {
    ...
    if ((a6 & 2) == 0) {
        ...
        if (__ctype_get_mb_cur_max() < 2) {
            ...
            int64_t v15 = mbstowcs(0, a1, 0); // 0x111cb
            if (v15 != -1) {
                ...
                if (v14 == 0) {
                    ...
                    int64_t v17 = mbstowcs((int32_t)v14, a1, (int32_t)v16); // 0x1123d
                    v3 = v2;
                    v4 = v2;
                    v5 = a1;
                    v6 = 0;
                    ...
                    if (v17 == 0) {
                        ...
                        *(int32_t *)(0x400000000 * v16 / 0x100000000 - 4 + v14) = 0;
                        ...
                        if (v18 == 0) {
                            // 0x113a8
                            v9 = 0x100000000 * wcswidth(v14, v16, v16) / 0x100000000;
                            goto lab_0x113c0;
                        } else {
                            char v19 = 0; // 0x11293
                            if ((int32_t)iswprint(v18) == 0) {
                                // 0x11295
                                *(int32_t *)v14 = 0xfffd;
                                v19 = 1;
                            }
                            ...
                            int64_t v25 = 0x100000000 * wcswidth(v14, v16, v21) / 0x100000000; // 0x112c5
                            v9 = v25;
                            if (v20 == 0) {
                                goto lab_0x113c0;
                            } else {
  ...
  lab_0x110a3:;
    ...
    if (a3 != 0) {
        ...
        *(char *)a2 = 0;
        ...
        int64_t v61 = mempcpy(a2, v39, v60 > v51 ? v51 : v60, v53); // 0x11110
  ...
  lab_0x112ed:;
    ...
    int64_t v66 = malloc((int64_t)v65); // 0x112f7
    if (v66 == 0) {
        // 0x113e9
        v3 = v2;
        v4 = v8;
        ...
        if (v67 != 0) {
            ...
            while (true) {
                ...
                v74 = v70;
                v73 = v69;
                int64_t v75 = wcwidth(v68); // 0x1134b
                int64_t v76; // 0x11023
                if ((int32_t)v75 != -1) {
      ...
      lab_0x11370_2:
        // 0x11370
        *v71 = 0;
        v3 = wcstombs((int32_t)v66, v14, v65);
        v4 = v72;
        v5 = v66;
        v6 = v66;
        v7 = v14;
