...
int64_t function_d683(int64_t a1, int64_t a2, int64_t a3) {
    int64_t v1 = dcgettext(0, "Valid arguments are:", 5); // 0xd6bf
    fputs_unlocked(v1, g17);
    int64_t v2 = 0; // 0xd6d7
        ...
        while (true) {
          lab_0xd719:
            ...
            if (v2 == 0) {
                ...
                int64_t v10 = v5;
                if ((int32_t)memcmp(v10, v8, a3) != 0) {
                    goto lab_0xd6e0;
                } else {
                    // 0xd730
                    __fprintf_chk(g17, 1, (int64_t)", %s", function_146c0(v6), v9);
                    v7 = v10;
                    goto lab_0xd704;
                }
            }
  ...
  lab_0xd6e0:
    // 0xd6e0
    __fprintf_chk(g17, 1, (int64_t)"\n  - %s", function_146c0(v6), v9);
    v7 = v8;
    goto lab_0xd704;
  lab_0xd704:
    // 0xd704
