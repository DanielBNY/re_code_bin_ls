...
int64_t function_4df3(int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5) {
    ...
    function_132d0();
    setlocale(6, (int64_t *)&g9);
    bindtextdomain("coreutils", "/usr/share/locale");
    textdomain("coreutils");
    *(int32_t *)&g42 = 2;
    function_4ca0(0xdfe0);
    *(char *)&g75 = 1;
    ...
    *(int32_t *)&g82 = 0;
    ...
    g80 = 0;
    g116 = 0;
    int64_t v3 = getenv("QUOTING_STYLE"); // 0x4f53
    ...
    if (v3 != 0) {
        ...
        if ((int32_t)v7 < 0) {
            int64_t v8 = function_146c0(v3); // 0x586c
            int64_t v9 = dcgettext(0, "ignoring invalid value of environment variable QUOTING_STYLE: %s", 5, 4); // 0x5882
            error(0, (int32_t)"ignoring invalid value of environment variable QUOTING_STYLE: %s" ^ (int32_t)"ignoring invalid value of environment variable QUOTING_STYLE: %s", (char *)v9, v8, a5);
            v4 = v8;
            v5 = v9;
    ...
    // 0x4f96
    g74 = 80;
    int64_t v12 = getenv("COLUMNS"); // 0x4fa8
    if (v12 != 0) {
        // 0x4fb5
        if (*(char *)v12 != 0) {
            // 0x589d
            if ((char)function_6bb0(v12, v6, v5) == 0) {
                int64_t v13 = function_146c0(v12); // 0x58b0
                error(0, (int32_t)"ignoring invalid width in environment variable COLUMNS: %s" ^ (int32_t)"ignoring invalid width in environment variable COLUMNS: %s", (char *)dcgettext(0, "ignoring invalid width in environment variable COLUMNS: %s", 5, v4), v13, a5);
            }
        }
    }
    // 0x4fbe
    ...
    uint16_t v15; // 0x4df3
    if (v15 != 0 == ((int32_t)ioctl(1, 0x5413, (int64_t *)&v14) != -1)) {
        // 0x585d
        g74 = v15;
    }
    int64_t v16 = &v14; // 0x4fcf
    int64_t v17 = getenv("TABSIZE"); // 0x4ff1
    g76 = 8;
    if (v17 != 0) {
        // 0x5009
        if ((int32_t)function_15db0(v17, 0, 0, (int64_t *)&v14, 0) != 0) {
            int64_t v18 = function_146c0(v17); // 0x5d55
            error(0, (int32_t)"ignoring invalid tab size in environment variable TABSIZE: %s" ^ (int32_t)"ignoring invalid tab size in environment variable TABSIZE: %s", (char *)dcgettext(0, "ignoring invalid tab size in environment variable TABSIZE: %s", 5, v16), v18, 0);
        } else {
            // 0x5023
            g76 = v14;
        }
    ...
    v14 = -1;
    int64_t v20 = getopt_long(v19, a2, "abcdfghiklmnopqrstuvw:xABCDFGHI:LNQRST:UXZ1", &g20, (int64_t *)&v14); // 0x5060
    int64_t v21; // 0x4df3
    int64_t v22; // 0x4df3
    int64_t v23; // 0x4df3
    if ((int32_t)v20 == -1) {
        // 0x50d0
        if (g97 == 0) {
            int64_t v24 = getenv("LS_BLOCK_SIZE"); // 0x5d8d
            function_109e0(v24, &g98, &g97);
            if (v24 == 0) {
                // 0x6610
                if (getenv("BLOCK_SIZE") != 0) {
                    goto lab_0x5db4;
                } else {
                    goto lab_0x50de;
                }
  ...
  lab_0x6295:;
    ...
    if (*(char *)v28 == 43) {
        // 0x659f
        v34 = v28 + 1;
        int64_t v35 = strchr(v34, 10); // 0x65ab
        v33 = v34;
        if (v35 == 0) {
            goto lab_0x65d9;
        } else {
  ...
  lab_0x6095_5:;
    ...
    int64_t v37; // 0x4df3
    int64_t v38 = v37;
    int64_t v39 = dcgettext(0, "unparsable value for LS_COLORS environment variable", 5, v38); // 0x60a3
    error(0, (int32_t)"unparsable value for LS_COLORS environment variable" ^ (int32_t)"unparsable value for LS_COLORS environment variable", (char *)v39, v38, v16);
    free(g89);
  ...
  lab_0x6061_2:;
    ...
    int64_t v42 = function_146c0((int64_t)&v41); // 0x6069
    int64_t v43; // 0x4df3
    error(0, (int32_t)"unrecognized prefix: %s" ^ (int32_t)"unrecognized prefix: %s", (char *)dcgettext(0, "unrecognized prefix: %s", 5, v43), v42, v16);
    v37 = v42;
    goto lab_0x6095_5;
  lab_0x5c2c:;
    // 0x5c2c
  ...
  lab_0x64c9:;
    ...
    if (g39 == 6) {
        ...
        v71 = v67;
        v73 = (int64_t)"target";
        if ((int32_t)strncmp((int64_t)g40, (int64_t)"target", 6) == 0) {
            // 0x64f7
            g121 = 1;
            v68 = v65;
            v70 = 6;
  ...
  lab_0x5e1f:
    ...
    goto lab_0x5e24;
  lab_0x65ec:;
    int64_t v208 = getenv("TIME_STYLE"); // 0x65f3
    v29 = (int64_t)"locale";
    if (v208 != 0) {
        int64_t v209 = strncmp(v208, (int64_t)"posix-", 6); // 0x59d7
        ...
        if ((int32_t)v209 != 0) {
            ...
            while ((char)function_eb50(2) != 0) {
                ...
                int64_t v212 = strncmp(v211, (int64_t)"posix-", 6); // 0x59d7
                v210 = v211;
                v27 = v211;
                if ((int32_t)v212 != 0) {
                    goto lab_0x6295;
  ...
  lab_0x59f2:;
    ...
    if (g93 != 0) {
        ...
        v121 = v117;
        v120 = v115;
        int64_t v123 = getenv("LS_COLORS"); // 0x5f5b
        ...
        if (v123 == 0) {
            ...
            if (*v124 == 0) {
                ...
                // 0x5f7a
                v41 = 0x3f3f;
                int64_t v126 = function_15ae0(v123); // 0x5f86
                v66 = 0x1000000 * g44;
                g89 = v126;
                v14 = v126;
                v127 = (int64_t)&v125;
                ...
                while (true) {
                  ...
                  lab_0x5fbd:;
                    ...
                    int64_t v145 = 0;
                    while ((int32_t)strcmp(&v41, v144, v143, v130, v16) != 0) {
            ...
            *(int64_t *)&g28 = (int64_t)"%m-%d %H:%M";
            ...
            if (v151 > 2) {
                ...
                if (v151 == 3) {
                    ...
                    v111 = 2;
                    if ((char)v152 != 0) {
                        int64_t v153 = dcgettext(0, g27, 2, 4); // 0x6448
                        *(int64_t *)&g27 = v153;
                        int64_t v154 = dcgettext(0, g28, 2, 4); // 0x6462
                        *(int64_t *)&g28 = v154;
                        v114 = 4;
                        v116 = 2;
                        v112 = (int64_t)g28;
  ...
  lab_0x5c42:
    ...
    if (g129 == 0) {
        ...
        if (function_f020(g129) != 0) {
            // 0x667c
            __assert_fail("hash_get_n_entries (active_dir_set) == 0", "src/ls.c", &g134, "main");
            v157 = (int64_t)"main";
            goto lab_0x669b;
        } else {
            // 0x5c6c
  ...
  lab_0x66d2:
    ...
    fputs_unlocked(dcgettext((int32_t)"time style" ^ (int32_t)"time style", "Valid arguments are:\n", 5, v105), (int64_t)g46);
    int64_t v106 = (int64_t)&g22 + 8; // 0x6725
    __fprintf_chk((int64_t)g46, 1, (int64_t)"  - [posix-]%s\n", (char *)(int64_t)"full-iso");
    ...
    // 0x6740
    fputs_unlocked(dcgettext(0, "  - +FORMAT (e.g., +%H:%M) for a 'date'-style format\n", 5, v107), (int64_t)g46);
    function_cca0(2);
    goto lab_0x676f;
  lab_0x5c74:
    // 0x5c74
    ...
    goto lab_0x669b;
  lab_0x6318:;
    int64_t v170 = getenv("COLORTERM"); // 0x631f
    if (v170 == 0) {
        goto lab_0x6374;
    } else {
        // 0x6329
  ...
  lab_0x676f:;
    ...
    // 0x678f
    __assert_fail("dev_ino_size <= obstack_object_size (&dev_ino_obstack)", "src/ls.c", &g130, "dev_ino_pop");
    // 0x67ae
    return __assert_fail("found", "src/ls.c", &g132, "main");
  lab_0x62f7:
    // 0x62f7
  ...
  lab_0x669b:
    ...
    goto lab_0x66a0;
  lab_0x6374:;
    int64_t v159 = getenv("TERM"); // 0x637b
    v160 = v118;
    if (v159 == 0) {
        goto lab_0x632e;
    } else {
        ...
        if (*(char *)v159 == 0) {
            ...
            while (true) {
                int64_t v163 = v162;
                if ((int32_t)strncmp(v163, (int64_t)"TERM ", 5) == 0) {
                    int64_t v164 = fnmatch(v163 + 5, v159, 0); // 0x63ec
                    v68 = v161;
                    v70 = 0;
                    v71 = v119;
                    v73 = v159;
  ...
  lab_0x65d9:
    ...
    *(int64_t *)&g28 = v33;
    ...
    goto lab_0x62f7;
  lab_0x66a0:;
    int64_t v158 = function_146c0(v30); // 0x66a3
    v104 = error(2, (int32_t)"invalid time style format %s" ^ (int32_t)"invalid time style format %s", (char *)dcgettext(0, "invalid time style format %s", 5, v32), v158, v31);
    v105 = v158;
    v103 = v30;
    goto lab_0x66d2;
  lab_0x632e_2:;
        ...
        if (g119 == 0) {
            ...
            if (*(int64_t *)(v174 + 48) > v176) {
                ...
                *(char *)v176 = 10;
                ...
                // 0x666d
                __overflow(v174, 10, 1, v171, v87, v122);
            }
            // 0x613b
            g57++;
            v173 = v171;
