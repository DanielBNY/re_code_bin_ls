...
int64_t function_ffa3(uint64_t a1, int64_t a2, int64_t a3, uint64_t a4, uint64_t a5) {
  ...
  lab_0x103c0:
    // 0x103c0
    __sprintf_chk(a2, 1, -1, "%.0Lf");
    int64_t v69 = strlen(a2); // 0x10403
  ...
  lab_0x100df:;
    ...
    __sprintf_chk(a2, 1, -1, "%.1Lf");
    uint64_t v91 = strlen(a2);
    if (v4 == 1) {
        if (v91 > v11 + v204) {
            goto lab_0x101b5;
        } else {
  ...
  lab_0x102eb:;
    ...
    *v117 = v81;
    int64_t v118 = strlen(v116); // 0x102fd
    ...
    *v122 = v80;
    ...
    int64_t v133 = v130;
    int64_t v134 = v131;
    int64_t v135 = memcpy(*v117 - v133, v128, v133); // 0x10367
    while (v134 != 0) {
        int64_t v136 = memcpy(v135 - v124, v116, v124); // 0x10389
        v126 = v134;
        v127 = *(char *)v132;
        if (v127 == 0) {
            // branch -> 0x1035e
        ...
        v133 = v130;
        v134 = v131;
        v135 = memcpy(v136 - v133, v128, v133);
    }
    // 0x104f0
    v84 = (int64_t)*v121;
    v85 = *v122;
