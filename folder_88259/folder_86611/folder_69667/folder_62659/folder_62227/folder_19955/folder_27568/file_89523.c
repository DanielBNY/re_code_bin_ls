...
int64_t function_15db3(int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5) {
    ...
    int64_t v15; // 0x15e45
    if ((int32_t)a3 < 37) {
        int32_t * v16 = (int32_t *)__errno_location(); // 0x15dfc
        *v16 = 0;
        unsigned char v17 = *(char *)&v1; // 0x15e05
        int64_t v18 = *(int64_t *)__ctype_b_loc(); // 0x15e13
        int64_t v19 = v17;
        ...
        if (v21 == 45) {
            ...
            if (v15 == a1) {
                ...
                if (v27 == 0 || a5 == 0) {
                    ...
                    v1 = a5;
                    int64_t v29 = strchr(a5, v28, v14); // 0x15ed1
                    v11 = v28;
                    v8 = a1;
                    v10 = 1;
                    v5 = 0;
  ...
  lab_0x15e5c:
    ...
    if (a5 == 0) {
        ...
        if (v73 != 0) {
            ...
            v1 = a5;
            int64_t v75 = strchr(a5, v74, v14); // 0x15f8c
