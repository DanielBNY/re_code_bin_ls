...
int64_t function_d4e3(int64_t a1, int64_t a2, int64_t a3, int64_t a4) {
    int64_t v1 = function_48c0(a1); // 0xd508
    if (a2 == 0) {
        // 0xd5c5
        return -1;
    }
    ...
    int32_t v7; // 0xd55f
    if ((int32_t)function_4770(a2, (char *)a1, v1) == 0) {
        // 0xd58a
        result = v2;
        if (function_48c0(a2) == v1) {
            // 0xd5c5
            return result;
        }
        // 0xd597
        ...
        if (a3 != 0 && v4 != -1) {
            // 0xd53a
            v7 = (int32_t)function_4a30(v4 * a4 + a3, a3, a4) != 0 ? 1 : 0x1000000 * v3 / 0x1000000;
            v5 = v4;
            v6 = v7;
        }
    }
    ...
    while (v11 != 0) {
        ...
        v5 = v4;
        v6 = v3;
        if ((int32_t)function_4770(v13, (char *)a1, v1) == 0) {
            // 0xd58a
            result = v2;
            if (function_48c0(v13) == v1) {
                // 0xd5c5
                return result;
            }
            // 0xd597
            ...
            if (a3 != 0 && v4 != -1) {
                // 0xd53a
                v7 = (int32_t)function_4a30(v4 * a4 + a3, v14, a4) != 0 ? 1 : 0x1000000 * v3 / 0x1000000;
                v5 = v4;
                v6 = v7;
            }
        }
...
int64_t function_d5f3(int64_t a1, int64_t a2, int64_t a3) {
    ...
    if (a3 == -1) {
        // 0xd660
        v1 = function_48a0(0, "invalid argument %s for %s", 5);
    } else {
        // 0xd60f
        v1 = function_48a0(0, "ambiguous argument %s for %s", 5);
    }
    // 0xd620
