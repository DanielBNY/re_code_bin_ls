...
int64_t function_d3e3(int64_t a1, uint64_t a2) {
    ...
    int64_t v3 = function_46e0(v2); // 0xd423
    int64_t result = 0; // 0xd42e
    while (v3 != 0) {
        uint64_t v4 = v2;
        int64_t v5 = v3;
        int64_t v6 = function_4820(a1, v5, v4); // 0xd439
        if (v6 < 0) {
            // 0xd498
            if (*(int32_t *)function_4760() != 34) {
                // 0xd4a2
                function_46d0(v5);
                result = 0;
                return result;
        ...
        while (v4 <= 0x3fffffffffffffff) {
            ...
            int64_t v8 = function_46e0(v7); // 0xd45e
            result = v8;
            if (v8 == 0) {
                return result;
            }
...
int64_t function_e293(int64_t a1, int64_t a2, int64_t a3) {
    ...
    *(int64_t *)result2 = function_15b10(a2);
...
int64_t function_15ca3(int64_t a1, int64_t a2) {
    int64_t result = function_4a00(0, 0); // 0x15caa
    if (result != 0 || *(int32_t *)function_4760() != 12) {
        // 0x15cb7
        return result;
    }
    // 0x15cca
