...
int64_t function_15b73(int64_t a1, int64_t a2, uint64_t a3, uint64_t a4, int64_t a5, int64_t a6, int32_t a7) {
    ...
    if (v2 != 0) {
        int64_t v4 = function_4760(); // 0x15c42
        if (v2 == 1) {
        ...
        if (result < a3 || result > a4) {
            int32_t * v7 = (int32_t *)function_4760();
  ...
  lab_0x15bdf:;
    int64_t v8 = function_15040(a1); // 0x15be2
    int32_t v9 = *v3; // 0x15be7
    int32_t v10 = v9 == 22 ? 0 : v9; // 0x15c00
    function_4c60((int64_t)(a7 == 0 ? 1 : a7), v10, "%s: %s", a6, v8, a6);
    goto lab_0x15c1a;
  lab_0x15c1a:
    // 0x15c1a
...
int64_t function_14983(int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5) {
    ...
    int32_t * v2 = (int32_t *)function_4760(); // 0x149c0
...
int64_t function_15253(int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5, uint64_t a6, int64_t a7) {
    ...
    if (a2 == 0) {
        // 0x15300
        function_4d20(a1, 1, "%s %s\n", a3, a4, a6);
        v1 = a6;
    } else {
        // 0x15274
        function_4d20(a1, 1, "%s (%s) %s\n", a2, a3, a4);
        v1 = a4;
    }
    int64_t v2 = function_48a0(0, (int64_t *)"(C)", 5); // 0x1529e
    function_4d20(a1, 1, "Copyright %s %d Free Software Foundation, Inc.", v2, (int64_t)&g29, v1);
    function_4a50(function_48a0(0, (int64_t *)"\nLicense GPLv3+: GNU GPL version 3 or later <https://gnu.org/licenses/gpl.html>.\nThis is free software: you are free to change and redistribute it.\nThere is NO WARRANTY, to the extent permitted by law.\n\n", 5), a1);
    if (a6 < 10) {
    ...
    int64_t v6 = function_48a0(0, (int64_t *)"Written by %s, %s, %s,\n%s, %s, %s, %s,\n%s, %s, and others.\n", 5); // 0x15402
    return function_4d20(a1, 1, (char *)v6, *(int64_t *)(a5 + 40), v5, v4);
}
