...
int64_t function_a900(uint32_t a1, int64_t a2) {
  ...
  lab_0xa921:;
    // 0xa921
    int64_t v37; // 0xa900
    __sprintf_chk(v2, 1, 21, "%lu", (int64_t *)(int64_t)a1, (int32_t)v37);
  ...
  lab_0xada8:;
    ...
    int32_t v465 = function_114b0(v464, 0); // 0xaddc
    if (g73 < v465) {
        // 0xadde
        g73 = v465;
    }
        ...
        if (g11 != 0) {
            ...
            if (g59 == 0) {
                ...
                if (v470 == 0) {
                    ...
                    int64_t v471 = function_114b0(v470, 0); // 0xb846
                    v438 = 512;
                    v439 = 0;
                    v440 = 0;
                    v441 = v468;
  ...
  lab_0xae3c:;
    ...
    if (*(int32_t *)&g63 != 0) {
        ...
        if ((*v233 & 0xb000) != 0x2000) {
            ...
            int32_t v414 = function_114b0(v412, 0);
            v371 = 1;
            v372 = v411;
            v373 = 0;
            v374 = g10;
  ...
  lab_0xb5c1:
    // 0xb5c1
    __sprintf_chk(v428, 1, 21, "%lu", (int64_t *)v429, v346);
    int64_t v430 = v428;
