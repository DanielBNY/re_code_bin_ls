...
int64_t function_17463(int64_t a1, int64_t a2, int64_t a3) {
    ...
    int64_t v1 = lseek(fileno(a1) & 0xffffffff, (int32_t)a2, a3 & 0xffffffff); // 0x174b0
...
int64_t function_17273(int64_t a1) {
    ...
    if (v1 == 0) {
        // 0x1729e
        result2 = *(int32_t *)__errno_location() != 9 ? 0xffffffff : 0;
    }
    // 0x172ae
    return result2;
}
...
int64_t function_dfe3(void) {
  ...
  lab_0xe011:;
    ...
    goto lab_0xe068;
  lab_0xe068:;
    int64_t v4 = _exit(g14); // 0xe06e
    int64_t v5 = v3; // 0xe06e
    int64_t v6; // 0xdfe3
    int64_t v7 = v6; // 0xe06e
    goto lab_0xe073;
  lab_0xe029:;
    int64_t v8 = dcgettext(0, "write error", 5); // 0xe037
    v4 = v8;
    v5 = v2;
    if (g19 == 0) {
        goto lab_0xe073;
    } else {
        int64_t v9 = function_14d70((int64_t)g19); // 0xe04b
        error(0, *(int32_t *)v2, (int64_t)"%s: %s", v9, v8);
        v3 = v2;
        v6 = v8;
        goto lab_0xe068;
    }
  lab_0xe073:
    // 0xe073
    error(0, *(int32_t *)v5, (int64_t)"%s", v4, v7);
    v3 = v5;
    v6 = v7;
    goto lab_0xe068;
}
...
int64_t function_17383(int64_t a1, int64_t a2) {
    // 0x17383
    if ((int32_t)fileno(a1) < 0) {
        // 0x173ef
        return fclose(a1);
    }
    // 0x17397
    if ((int32_t)__freading(a1) != 0) {
        // 0x173d0
        if (lseek(fileno(a1) & 0xffffffff, 0, 1) == -1) {
            // 0x173ef
            return fclose(a1);
        }
    }
    ...
    int32_t * v1 = (int32_t *)__errno_location(); // 0x173b4
    int32_t v2 = *v1; // 0x173b4
    int64_t result = fclose(a1); // 0x173c2
    if (v2 != 0) {
        // 0x17400
        *v1 = v2;
        result = 0xffffffff;
...
int64_t function_17413(int64_t a1, int64_t a2) {
    if (a1 == 0 || (int32_t)__freading(a1) == 0) {
        // 0x1742f
