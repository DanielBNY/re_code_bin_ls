...
int64_t function_e533(int64_t a1, int64_t a2, int64_t a3) {
    ...
    int64_t v4 = function_48c0(a2); // 0xe56b
    int64_t v5; // 0xe533
    char v6 = v5;
    bool v7; // 0xe533
    char v8; // 0xe533
    ...
    int64_t v9 = v7;
    int64_t result = function_46e0(v3 + 1 + v4 + v9); // 0xe5cc
    if (result == 0) {
        // 0xe60d
        return result;
    }
    // 0xe5d9
    int64_t v10; // 0xe533
    int64_t v11 = function_4c40(result, a1, v3, v10); // 0xe5e2
    ...
    *(char *)v11 = v8;
    ...
    // 0xe5ff
    *(char *)function_4c40(v12, a2, v4, (int64_t)v8) = 0;
    // 0xe60d
    return result;
}
