...
int64_t function_16cf0(int64_t a1) {
    int32_t * v1 = (int32_t *)__errno_location(); // 0x16d0a
...
int64_t function_16df0(int64_t a1, uint64_t a2) {
    ...
    int64_t v7 = v5 + 1 + strlen(v5); // 0x16e5b
    int64_t v8; // 0x16df0
    int64_t v9; // 0x16e65
    int64_t v10; // 0x16e6e
    int64_t v11; // 0x16e7b
    ...
    int64_t v12 = strcmp(v7, v2); // 0x16e36
    // 0x16e88
    *v1 = v7;
    while ((int32_t)v12 != 0) {
        // 0x16e3f
